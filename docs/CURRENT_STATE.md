...
| Tests (391 EditMode cases, 35 PlayMode) | 27 | 9,368 | Written, **never executed** |
...
| **Tests** | **UNCONFIRMED — 426 tests written (391 EditMode + 35 PlayMode), 0 executed.** The PlayMode suite self-skips without the scenes, so *ignored* must never be read as *passed*. |
