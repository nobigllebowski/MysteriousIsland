...
| Tests (392 EditMode cases, 35 PlayMode) | 27 | 9,392 | Written, **never executed** |
...
| **Tests** | **UNCONFIRMED — 427 tests written (392 EditMode + 35 PlayMode), 0 executed.** The PlayMode suite self-skips without the scenes, so *ignored* must never be read as *passed*. |
